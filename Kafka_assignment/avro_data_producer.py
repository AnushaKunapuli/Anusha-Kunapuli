...
# kafka_config = {
#     'bootstrap.servers': 'psrc-9jzo5.us-central1.gcp.confluent.cloud:9092',
#     'sasl.mechanisms': 'PLAIN',
#     'security.protocol': 'SASL_SSL',
#     'sasl.username': 'JZAW7ATC5VU377HN',
#     'sasl.password': 'lwXBMyGSRokBMHWxDZFWwN6liu0Wlz86Gwmquzwi7Cu3F8VbjnfsDHhUej85kpPW'
# }
...
# 'basic.auth.user.info': '{}:{}'.format('JZAW7ATC5VU377HN','lwXBMyGSRokBMHWxDZFWwN6liu0Wlz86Gwmquzwi7Cu3F8VbjnfsDHhUej85kpPW')
...
if not rows:
    ...
    for row in rows:
        ...
        # Produce to Kafka
        producer.produce(topic='kafka_assignment_topic', key=str(value['ID']), value=value, on_delivery=delivery_report)
        producer.flush()
