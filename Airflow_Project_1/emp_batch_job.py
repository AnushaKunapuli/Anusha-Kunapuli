...
def process_data():
    ...
    emp_data_path = f"gs://us-central1-airflow-cluster-46effcb0-bucket/airflow-project1/data/employee.csv"
    dept_data_path = f"gs://us-central1-airflow-cluster-46effcb0-bucket/airflow-project1/data/department.csv"
    output_path = f"gs://us-central1-airflow-cluster-46effcb0-bucket/airflow-project1/output"
